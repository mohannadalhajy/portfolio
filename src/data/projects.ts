...
export const projects: Project[] = [
  ...
  },
  {
    ...
    links: [],
    photos: [
      "/exyar/exyar-home.png",
      "/exyar/exyar-car-list.png",
      "/exyar/exyar-car-detail.png",
      "/exyar/exyar-my-car.png",
      "/exyar/exyar-contact-us.png",
      "/exyar/exyar-admin-dashboard.png",
      "/exyar/exyar-admin-car-listing.png",
      "/exyar/exyar-admin-bookings.png",
      "/exyar/exyar-admin-users.png",
      "/exyar/exyar-admin-settings.png",
    ],
  },
  {
    slug: "pms",
    ...
    photos: [
      "/pms/pms-login.png",
      "/pms/pms-dashboard.png",
      "/pms/pms-board.png",
      "/pms/pms-sprint.png",
      "/pms/pms-team.png",
      "/pms/pms-business-plan.png",
      "/pms/pms-design.png",
      "/pms/pms-approval.png",
      "/pms/pms-admin-projects.png",
    ],
  },
  {
    slug: "zadlaw",
    ...
    links: [],
    photos: [
      "/zadlaw/zadlaw-website-home.png",
      "/zadlaw/zadlaw-website-about.png",
      "/zadlaw/zadlaw-website-pricing.png",
      "/zadlaw/zadlaw-website-contact.png",
      "/zadlaw/zadlaw-admin-login.png",
      "/zadlaw/zadlaw-admin-dashboard.png",
      "/zadlaw/zadlaw-admin-appointments.png",
      "/zadlaw/zadlaw-admin-new-blog.png",
      "/zadlaw/zadlaw-admin-legal-advisory.png",
    ],
  },
  {
    slug: "hr-software",
    ...
    links: [],
    photos: [
      "/hr-software/hr-login.png",
      "/hr-software/hr-super-admin-companies.png",
      "/hr-software/hr-employees.png",
      "/hr-software/hr-add-employee.png",
      "/hr-software/hr-tasks.png",
      "/hr-software/hr-time-sheet.png",
      "/hr-software/hr-roles.png",
      "/hr-software/hr-create-role.png",
    ],
  },
  {
