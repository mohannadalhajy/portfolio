...
export const projects: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      problem:
        "Save In Gold needed a CRM to manage a high volume of leads (tens of thousands) coming from multiple sources — mobile app, kiosks, website, social media — with different staff needing different levels of access: admins overseeing branches and roles, sales managers overseeing agents and performance, and agents working their own leads and tasks.",
      approach:
        "Built the backend powering a role-based CRM with granular permission management, lead assignment and tracking across sources, a task/follow-up system tied to leads, a unified inbox for lead conversations, and branch/exhibition management for admins — with dashboards aggregating leads, tasks, and account performance by source and by agent.",
      result:
        "A production CRM in daily use managing tens of thousands of leads and tasks across multiple lead sources, with clean role separation between Admin, Sales Manager, and Sales Agent access levels.",
    },
    myContribution: [
      "Implemented the backend for the CRM covering authentication, role-based access control, and permission management.",
      "Built lead management APIs supporting multiple lead sources (mobile app, kiosk, website, social media/WhatsApp, missing app data).",
      "Developed the agent and sales manager management systems including lead assignment and performance tracking.",
      "Built the task/follow-up system tying tasks to leads with status tracking (pending, completed, not completed).",
      "Implemented a unified inbox system for managing conversations with leads, including message templates and quick replies.",
      "Built branch and exhibition management features for admin-level operations.",
      "Developed reporting endpoints covering lead reports, social media performance, and status change history.",
      "Implemented dashboard aggregation APIs summarizing leads, open accounts, and task status by source and by agent.",
    ],
    challengesSolved: [
      "Designed a role-based permission system distinguishing Admin, Sales Manager, and Sales Agent access levels.",
      "Built lead-assignment logic and tracking across a high volume of leads from multiple acquisition sources.",
      "Implemented a task/follow-up workflow tied to individual leads with agent-level accountability.",
      "Centralized lead communication into a single inbox view across all sources.",
      "Aggregated large volumes of lead, task, and account data into responsive dashboard views by source and by agent.",
    ],
    technicalHighlights: [
      "Role-based authentication and authorization (Admin / Sales Manager / Sales Agent).",
      "Lead management across multiple acquisition sources with assignment and status tracking.",
      "Task/follow-up system linked to leads with completion tracking.",
      "Unified inbox with message templates and quick replies for lead communication.",
      "Branch and exhibition (event) management for admin operations.",
      "Reporting and analytics endpoints (lead reports, social media, status changes).",
      "Dashboard aggregation by lead source and by agent.",
    ],
    highlights: [
      "Multi-role CRM: Admin, Sales Manager, and Sales Agent dashboards.",
      "Lead tracking across mobile app, kiosk, website, and social media sources.",
      "Task and follow-up management tied to individual leads.",
      "Unified inbox for centralized lead communication.",
      "Branch and exhibition management for admins.",
      "Role management with granular, per-role permissions.",
    ],
    stack: ["NestJS", "Node.js", "TypeScript", "Next.js", "MongoDB", "Redis"],
    links: [],
    photos: [
